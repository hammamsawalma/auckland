...
export function Navbar() {
    ...
    return (
        ...
        >
            <div
                className={`flex items-center justify-between gap-4 xl:gap-8 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden ${scrolled
            ...
            >
                ...
                {/* Main Navigation */}
                <nav className="hidden lg:flex items-center justify-center lg:gap-3 xl:gap-6 whitespace-nowrap shrink-0">
                ...
                {/* Right Actions */}
                <div className="flex items-center lg:flex-1 justify-end gap-3 md:gap-5 shrink-0">
                    ...
                    <Link
                        href="/contact"
                        className={`hidden lg:inline-flex h-10 px-6 items-center justify-center text-xs font-bold uppercase tracking-widest transition-all duration-300 hover:scale-105 shrink-0 ${scrolled
